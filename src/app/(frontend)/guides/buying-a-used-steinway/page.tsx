    ...
    <main className="min-h-screen bg-piano-cream">
      ...
      <div className="max-w-7xl mx-auto px-8 py-24">
        <div className="grid lg:grid-cols-[1fr_280px] gap-16 items-start">
          {/* Article Body */}
          <article className="prose prose-lg max-w-none prose-headings:font-normal prose-headings:text-piano-black prose-a:text-piano-gold">
            <p className="text-xl text-piano-stone leading-relaxed not-prose mb-10 font-cormorant font-light">
            ...
            <section id="models" className="mb-14">
              ...
              <div className="not-prose space-y-4 mb-6">
                {[
                  ...
                  <div key={model} className="flex gap-4 p-4 bg-piano-cream border border-piano-linen">
                    <div className="shrink-0 w-24">
                      <span className="font-medium text-piano-black">{model}</span>
                      <span className="text-piano-stone text-sm ml-2">{size}</span>
                    </div>
            ...
            <section id="inspection" className="mb-14">
              ...
              <div className="not-prose space-y-6">
                {[
                  ...
                  <div key={area} className="p-6 bg-piano-cream border border-piano-linen">
                    <h3 className="font-cormorant font-light text-3xl text-piano-black mb-2">{area}</h3>
                    <p className="text-piano-stone text-sm leading-relaxed mb-3">{what}</p>
            ...
            <section id="condition" className="mb-14">
              ...
              <div className="not-prose space-y-3">
                {[
                  ...
                  <div key={rating} className="flex gap-4 p-4 bg-piano-cream border border-piano-linen">
                    <span className="font-display text-xs tracking-wide uppercase font-semibold text-piano-stone w-20 shrink-0 pt-0.5">
                      {rating}
                    </span>
                    <p className="text-piano-stone text-sm leading-relaxed">{desc}</p>
                  </div>
                ))}
              </div>
            ...
            <section id="pricing" className="mb-14">
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={`${era}-${cond}`} className="border-b border-piano-linen">
                        <td className="py-3 pr-6 font-medium text-piano-black">{era}</td>
                        <td className="py-3 pr-6 text-piano-stone">{cond}</td>
              ...
              <p className="text-piano-stone text-xs mt-4 leading-relaxed">
                ...
                <Link
                  ...
                  className="text-piano-gold hover:underline"
                >
