        ...
        <div className="grid lg:grid-cols-[1fr_280px] gap-16 items-start">
          ...
          <article className="max-w-none">
            ...
            <section id="model-prices" className="mb-14">
              ...
              {[
                ...
                <div key={model} className="mb-8">
                  <div className="flex items-baseline gap-3 mb-3">
                    <h3 className="font-cormorant font-light text-2xl text-piano-black">
                      {model}
                    </h3>
                    <span className="text-piano-stone text-sm">{size}</span>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-piano-linen">
                          <th className="text-left py-2 pr-6 font-display text-[11px] tracking-[0.45em] uppercase text-piano-stone">
                            Era
                          </th>
                          <th className="text-left py-2 pr-6 font-display text-[11px] tracking-[0.45em] uppercase text-piano-stone">
                            Condition
                          </th>
                          <th className="text-right py-2 font-display text-[11px] tracking-[0.45em] uppercase text-piano-stone">
                            Market Range
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        {rows.map(([era, cond, price]) => (
                          <tr key={`${era}-${cond}`} className="border-b border-piano-linen">
                            <td className="py-2.5 pr-6 font-medium text-piano-black">{era}</td>
                            <td className="py-2.5 pr-6 text-piano-stone">{cond}</td>
              ...
              <p className="text-piano-stone text-xs mt-2 leading-relaxed">
            ...
            <section id="what-affects-price" className="mb-14">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={factor} className="p-5 bg-piano-cream border border-piano-linen">
                    <h3 className="font-cormorant font-light text-2xl text-piano-black mb-2">{factor}</h3>
                    <p className="text-piano-stone text-sm leading-relaxed">{detail}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section id="finish-premium" className="mb-14">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={finish} className="flex gap-4 items-start py-2.5 border-b border-piano-linen">
                    <span className="font-medium text-piano-black text-sm w-52 shrink-0">{finish}</span>
                    <span className="text-piano-stone text-sm">{note}</span>
                  </div>
                ))}
              </div>
            ...
            <section id="overpriced" className="mb-14">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={flag} className="flex gap-4 p-4 bg-piano-cream border border-piano-linen list-none">
                    <span className="text-piano-gold mt-0.5 shrink-0">✕</span>
                    <div>
                      <span className="font-semibold text-piano-black text-sm block mb-1">{flag}</span>
                      <span className="text-piano-stone text-sm leading-relaxed">{desc}</span>
                    </div>
                  </li>
                ))}
              </ul>
