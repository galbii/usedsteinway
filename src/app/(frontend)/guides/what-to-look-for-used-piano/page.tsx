        ...
        <div className="grid lg:grid-cols-[1fr_280px] gap-16 items-start">
          ...
          <article className="max-w-none">
              ...
              <ul className="space-y-3 mb-6">
                {[
                  ...
                  <li key={i} className="flex gap-3">
                    ...
                    <span className="text-piano-stone text-sm leading-relaxed">{q}</span>
                  </li>
                ))}
              </ul>
            ...
            <section id="ten-things" className="mb-14">
              ...
              <p className="text-piano-stone leading-relaxed mb-6">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={number} className="p-6 bg-piano-cream border border-piano-linen">
                    <div className="flex items-start gap-4 mb-4">
                      <span className="font-cormorant font-light text-3xl text-piano-stone/40 shrink-0 leading-none">
                        {number}
                      </span>
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-1">
                          <h3 className="font-cormorant font-light text-2xl text-piano-black">{title}</h3>
                          <span className={`font-display text-[11px] tracking-[0.3em] uppercase px-2 py-0.5 ${
                            priority === 'Critical'
                              ? 'text-red-700 bg-red-50'
                              : priority === 'High'
                              ? 'text-amber-700 bg-amber-50'
                              : 'text-piano-stone bg-piano-linen'
                          }`}>
                            {priority}
                          </span>
                        </div>
                    ...
                    <div className="space-y-3 ml-14">
                      <div>
                        <span className="font-display text-[11px] tracking-[0.3em] uppercase text-piano-stone block mb-1">How to Check</span>
                        <p className="text-piano-stone text-sm leading-relaxed">{howTo}</p>
                      </div>
                      <div>
                        <span className="font-display text-[11px] tracking-[0.3em] uppercase text-piano-stone block mb-1">What It Means</span>
                        <p className="text-piano-stone text-sm leading-relaxed">{whatItMeans}</p>
                      </div>
                      <div>
                        <span className="font-display text-[11px] tracking-[0.3em] uppercase text-piano-stone block mb-1">Can You Evaluate This Yourself?</span>
                        <p className="text-piano-stone text-sm leading-relaxed">{canYouTell}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <section id="diy-vs-rpt" className="mb-14">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 bg-piano-cream border border-piano-linen">
                  <h3 className="font-cormorant font-light text-2xl text-piano-black mb-4">
                    You Can Evaluate
                  </h3>
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={item} className="flex gap-2 text-sm text-piano-stone">
              ...
              <p className="text-piano-stone leading-relaxed mt-6">
            ...
            <section id="the-test-play" className="mb-14">
              ...
              <ol className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex gap-3 text-piano-stone text-sm leading-relaxed">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={flag} className="p-5 bg-red-50 border border-red-100">
                    <h3 className="font-cormorant font-light text-2xl text-red-800 mb-2">{flag}</h3>
                    <p className="text-piano-stone text-sm leading-relaxed mb-3">{why}</p>
                    <span className="font-display text-[11px] tracking-[0.3em] uppercase text-red-600">
                      {severity}
                    </span>
                  </div>
                ))}
