...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-piano-cream">
      {/* Page Header */}
      <section className="bg-piano-black py-16 px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_420px] gap-16">
          ...
          <div>
            {submitted ? (
              <div className="py-16 text-center">
                ...
                <h2
                  className="text-3xl font-medium text-piano-black mb-4"
                  style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                >
                  Message Received
                </h2>
                ...
                <Link
                  href="/pianos"
                  className="inline-block border border-piano-black text-piano-black px-8 py-3 font-display text-xs tracking-[0.2em] uppercase hover:bg-piano-black hover:text-white transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  <label className="block font-display text-xs tracking-[0.2em] uppercase text-gray-500 mb-4">
                    ...
                    {inquiryTypes.map((type) => (
                      <button
                        ...
                        className={cn(
                          ...
                          inquiryType === type.id
                            ? 'border-piano-burgundy bg-piano-burgundy/5'
                            : 'border-gray-200 hover:border-gray-300 bg-white',
                        )}
                      >
                        <p className={cn(
                          'font-display text-xs tracking-widest uppercase mb-1',
                          inquiryType === type.id ? 'text-piano-burgundy' : 'text-gray-700',
                        )}>
                          {type.label}
                        </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block font-display text-xs tracking-[0.15em] uppercase text-gray-500 mb-2">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 px-4 py-3 text-gray-900 text-sm focus:outline-none focus:border-piano-gold transition-colors bg-white"
                      placeholder="Your name"
                    />
                  </div>
                  <div>
                    <label className="block font-display text-xs tracking-[0.15em] uppercase text-gray-500 mb-2">
                      Email Address <span className="text-piano-burgundy">*</span>
                    </label>
                    <input
                      type="email"
                      required
                ...
                <div>
                  <label className="block font-display text-xs tracking-[0.15em] uppercase text-gray-500 mb-2">
                    Message <span className="text-piano-burgundy">*</span>
                  </label>
                  <textarea
                    required
                    rows={6}
                    ...
                    className="w-full border border-gray-200 px-4 py-3 text-gray-900 text-sm focus:outline-none focus:border-piano-gold transition-colors bg-white resize-none"
                    placeholder={
                      inquiryType === 'buy'
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full sm:w-auto bg-piano-burgundy text-white px-12 py-4 font-display text-xs tracking-[0.2em] uppercase hover:bg-piano-burgundy/90 transition-colors"
                  >
                    Send Message
                  </button>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link
                href="/visit"
                className="block text-center border border-piano-black/20 py-3 text-piano-black font-display text-xs tracking-widest uppercase hover:border-piano-burgundy hover:text-piano-burgundy transition-colors"
              >
                Plan Your Visit
              </Link>
              <Link
