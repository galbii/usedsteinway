    ...
    <main className="min-h-screen bg-piano-cream">
      ...
      <section className="py-20 px-8 bg-piano-cream">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2
              className="text-3xl md:text-4xl font-medium text-piano-black"
              style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
            >
              How It Works
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 max-w-4xl mx-auto">
            {[
              ...
              <div
                key={step}
                className="relative border border-gray-200 p-8 bg-white"
              >
                {i < 2 && (
                  <div className="hidden md:block absolute top-12 -right-px w-px h-8 bg-gray-200 z-10" />
                )}
                <p className="text-piano-burgundy/20 font-display text-6xl font-bold mb-4 leading-none">
                  {step}
                </p>
                <h3
          ...
          <div className="text-center mt-10">
            <Link
              ...
              className="inline-block bg-piano-burgundy text-white px-12 py-4 font-display text-xs tracking-[0.2em] uppercase hover:bg-piano-burgundy/90 transition-colors"
            >
              Start the Process
            </Link>
          </div>
      ...
      <section className="py-20 px-8 bg-piano-black border-t border-piano-gold/10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
          {/* What We Buy */}
          <div>
            <p className="font-display text-xs tracking-[0.2em] uppercase text-piano-gold mb-4">
              What We Purchase
            </p>
            <h2
            ...
            <ul className="space-y-3">
              {acceptedBrands.map(({ name, note }) => (
                <li key={name} className="flex gap-4 items-start">
                  ...
                  <div>
                    <span className="text-piano-cream text-sm font-medium">{name}</span>
                    <span className="text-piano-silver/60 text-sm"> — {note}</span>
                  </div>
                </li>
              ))}
            </ul>
          ...
          {/* What We Don't Buy */}
          <div>
            <p className="font-display text-xs tracking-[0.2em] uppercase text-piano-gold/40 mb-4">
              Outside Our Scope
            </p>
            <h2
              className="text-2xl font-medium text-piano-cream mb-8"
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={category} className="flex gap-4">
                  ...
                  <div>
                    <p className="text-piano-silver text-sm font-medium">{category}</p>
                    <p className="text-piano-silver/50 text-sm leading-relaxed">{reason}</p>
                  </div>
                </div>
              ))}
            </div>
            <div className="border border-piano-gold/15 p-5">
              <p className="text-piano-silver/70 text-sm leading-relaxed">
      ...
      <section className="py-20 px-8 bg-piano-cream border-t border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mx-auto mb-12 text-center">
            ...
            <h2
              className="text-3xl md:text-4xl font-medium text-piano-black mb-5"
              style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {valueFactors.map(({ label, detail }) => (
              <div key={label} className="bg-white border border-gray-100 p-6">
                <p
                  className="text-piano-black font-medium mb-3"
                  style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                >
                  {label}
                </p>
      ...
      <section className="py-16 px-8 bg-piano-charcoal">
        <div className="max-w-4xl mx-auto text-center">
          <p className="font-display text-xs tracking-[0.3em] uppercase text-piano-gold mb-6">
            Our Commitment to Your Instrument
          </p>
          <blockquote>
            <p
              className="text-2xl md:text-3xl text-piano-cream font-medium leading-snug mb-6"
              style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
            >
              "We're not just buying your piano — we're finding it a new home."
            </p>
          </blockquote>
          <p className="text-piano-silver/70 leading-relaxed max-w-2xl mx-auto">
      ...
      <section className="py-20 px-8 bg-piano-cream border-t border-gray-100">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2
              className="text-3xl font-medium text-piano-black"
              style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
            >
            ...
            {faqs.map(({ q, a }) => (
              <details key={q} className="group py-6">
                <summary className="flex justify-between items-start gap-6 cursor-pointer list-none">
                  <h3
                    className="text-piano-black font-medium leading-snug group-open:text-piano-burgundy transition-colors"
                    style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                  >
                    {q}
                  </h3>
                  <span className="text-piano-burgundy shrink-0 mt-0.5 transition-transform group-open:rotate-45">
                    +
                  </span>
                </summary>
      ...
      <section className="py-20 px-8 bg-piano-black border-t border-piano-gold/10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2
            className="text-3xl md:text-4xl font-medium text-piano-cream mb-6"
            style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-block border border-piano-gold text-piano-gold px-10 py-4 font-display text-xs tracking-[0.2em] uppercase hover:bg-piano-gold/10 transition-colors"
            >
              Call (603) 555-0123
            </a>
          </div>
