        ...
        <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="bg-white border border-gray-100 divide-y divide-gray-100">
                {[
                  ...
                  <div key={day} className="flex justify-between items-center px-6 py-4">
                    ...
                    <span className="font-medium text-piano-black text-sm">{hours}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-piano-black p-6">
                ...
                <a
                  ...
                  className="inline-block border border-piano-gold text-piano-gold px-6 py-2.5 font-display text-xs tracking-[0.2em] uppercase hover:bg-piano-gold/10 transition-colors"
                >
                  Get Directions
                </a>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-piano-cream border border-piano-gold/20 p-8">
              ...
              <h3
                className="text-xl font-medium text-piano-black mb-4"
                style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
              >
              ...
              <div className="flex flex-col gap-3">
                <a
                  ...
                  className="block text-center bg-piano-burgundy text-white py-3.5 font-display text-xs tracking-[0.2em] uppercase hover:bg-piano-burgundy/90 transition-colors"
                >
                  Call (603) 555-0123
                </a>
                <Link
                  href="/contact?subject=Schedule+Visit"
                  className="block text-center border border-piano-black text-piano-black py-3.5 font-display text-xs tracking-[0.2em] uppercase hover:bg-piano-black hover:text-white transition-colors"
                >
                  Send a Message
                </Link>
              </div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex gap-3">
                    ...
                    <span className="text-piano-silver/80 text-sm leading-relaxed">{tip}</span>
                  </li>
                ))}
              </ul>
            </div>
