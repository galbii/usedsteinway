            ...
            <section id="terminology" className="mb-14">
              ...
              <div className="space-y-4 mb-6">
                {[
                  ...
                  <div key={term} className="p-5 bg-white border border-gray-100">
                    <div className="flex items-start justify-between gap-4 mb-2">
                      <h3 className="font-semibold text-piano-black">{term}</h3>
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed mb-2">{scope}</p>
                    <p className="text-gray-400 text-xs italic">{note}</p>
                  </div>
                ))}
              </div>
            ...
            <section id="components" className="mb-14">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={component} className="p-6 bg-white border border-gray-100">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <h3 className="font-semibold text-piano-black">{component}</h3>
                      <div className="text-right shrink-0">
                        <span className="text-gray-400 text-xs block">{lifespan}</span>
                        <span className="font-semibold text-piano-black text-sm">{cost}</span>
                      </div>
                    </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="text-left py-3 pr-6 font-display text-xs tracking-widest uppercase text-gray-400">Model</th>
                      <th className="text-left py-3 pr-6 font-display text-xs tracking-widest uppercase text-gray-400">Partial Restoration</th>
                      <th className="text-right py-3 font-display text-xs tracking-widest uppercase text-gray-400">Full Rebuild</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={model} className="border-b border-gray-100">
                        <td className="py-3 pr-6 font-medium text-gray-800">{model}</td>
                        <td className="py-3 pr-6 text-gray-600">{partial}</td>
            ...
            <section id="evaluating-quality" className="mb-14">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex gap-4 p-5 bg-white border border-gray-100 list-none">
                    <span className="font-display text-piano-gold text-sm font-semibold shrink-0 w-6">
                      {i + 1}.
                    </span>
                    <div>
                      <span className="font-semibold text-gray-800 text-sm block mb-1">{check}</span>
