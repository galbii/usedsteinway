            ...
            <section id="room-size" className="mb-14">
              ...
              <div className="space-y-2 mb-6">
                {[
                  ...
                  <div key={model} className="grid grid-cols-[1fr_1fr_1fr] gap-3 py-2.5 border-b border-gray-100 text-sm">
            ...
            <section id="model-by-room" className="mb-14">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={room} className="p-6 bg-white border border-gray-100">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <div>
                        <h3 className="font-semibold text-piano-black">{room}</h3>
                        <p className="text-gray-400 text-xs mt-1">{examples}</p>
                      </div>
                      <span className="font-display text-xs tracking-wide uppercase text-piano-burgundy bg-piano-burgundy/10 px-3 py-1 shrink-0">
                        {recommendation}
                      </span>
                    </div>
            ...
            <section id="budget" className="mb-14">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={budget} className="flex gap-4 py-2.5 border-b border-gray-100 text-sm">
            ...
            <section id="buyer-profiles" className="mb-14">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={profile} className="p-6 bg-white border border-gray-100">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <h3 className="font-semibold text-piano-black text-sm">{profile}</h3>
                      <span className="font-display text-xs tracking-wide uppercase text-piano-burgundy bg-piano-burgundy/10 px-3 py-1 shrink-0">
                        {ideal}
                      </span>
                    </div>
