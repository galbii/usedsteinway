            ...
            <section id="tone" className="mb-14">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="p-6 bg-piano-black text-white">
                  <h3
                    className="text-lg font-medium mb-4 text-piano-gold"
                    style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                  >
                    Steinway
                  </h3>
            ...
            <section id="repertoire" className="mb-14">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={repertoire} className="grid md:grid-cols-[1fr_auto_2fr] gap-4 p-4 bg-white border border-gray-100 items-start">
                    <span className="font-medium text-piano-black text-sm">{repertoire}</span>
                    <span className="font-display text-xs tracking-wide uppercase text-piano-burgundy bg-piano-burgundy/10 px-3 py-1 self-start whitespace-nowrap">
                      {verdict}
                    </span>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="text-left py-3 pr-6 font-display text-xs tracking-widest uppercase text-gray-400">
                        Steinway
                      </th>
                      <th className="text-left py-3 pr-6 font-display text-xs tracking-widest uppercase text-gray-400">
                        Length
                      ...
                      <th className="text-right py-3 font-display text-xs tracking-widest uppercase text-gray-400">
                        Length
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={sm} className="border-b border-gray-100">
                        <td className="py-3 pr-6 font-medium text-gray-800">{sm}</td>
                        <td className="py-3 pr-6 text-gray-400">{sl}</td>
                        <td className="py-3 pr-6 font-medium text-gray-800">{bm}</td>
                        <td className="py-3 text-right text-gray-400">{bl}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
