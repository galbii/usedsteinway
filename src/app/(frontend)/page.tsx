...
import { queryGalleryImages, queryHeroImages } from '@/lib/payload/media'
import { queryBrands } from '@/lib/payload/brands'

export default async function HomePage() {
  const [siteSettings, featured, recentPosts, heroImages, galleryImages, brands, availablePianosCount] = await Promise.all([
