...
export default buildConfig({
  ...
  plugins,
  email: resendAdapter({
    defaultFromAddress: process.env.RESEND_DEFAULT_FROM_ADDRESS || 'noreply@usedsteinways.com',
    defaultFromName: process.env.RESEND_DEFAULT_FROM_NAME || 'Used Steinways',
