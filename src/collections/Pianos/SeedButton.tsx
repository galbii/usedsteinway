  ...
  return (
    <div style={{ padding: '0 0 16px' }}>
      ...
      >
        ...
        {status === 'idle' && '🌱 Seed Pianos (47 listings)'}
      ...
      {status === 'idle' && (
        <p style={{ margin: '6px 0 0', fontSize: '11px', color: 'var(--theme-elevation-500)' }}>
          Seeds 47 piano listings as drafts from the actual inventory (Steinway, Bösendorfer, Bechstein, Blüthner, Schimmel, Petrof, Bohemia, Boston, Essex, Shigeru Kawai). Safe to run — skips slugs that already exist. Seed brands first, then add images and publish.
        </p>
      )}
